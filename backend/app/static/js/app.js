  ...
  <div class="grid min-h-screen place-items-center bg-canvas p-6">
    <div class="${panel} w-full max-w-lg p-8">
      ...
      <p class="mb-6 text-[15px] leading-relaxed text-muted">
        ...
        PSLF models, drawings, forms, and QC — generated in minutes from the kickoff inputs.
      </p>
    ...
    return `
      <div class="flex-1 p-7">
        ...
        <div class="mb-5 grid gap-3 sm:grid-cols-2">
          ...
          <div class="rounded-card border border-line bg-soft p-4"><span class="font-mono text-[11px] uppercase tracking-[0.08em] text-muted">Track</span><strong class="mt-1 block">${esc(s.track)}</strong></div>
        ...
        <div class="mb-3 grid gap-3 sm:grid-cols-2">
          <div class="rounded-card border border-line bg-soft px-4 py-3 text-[13px]">
            <strong class="mb-1 block text-ink">Generated by GridPilot</strong>
  ...
  if (step === 2) {
    ...
    return `
      <div class="flex-1 p-7">
        ...
        <p class="mb-5 max-w-2xl text-[15px] leading-relaxed text-muted">
          Example files for ${esc(s.project)} are already uploaded and awaiting submission — preview
    ...
    return `
      <div class="flex-1 p-7">
        ...
        <p class="mb-4 max-w-2xl text-[15px] leading-relaxed text-muted">
          ...
          review. Each check cites the CAISO requirement it enforces and the document it examined; both preview
