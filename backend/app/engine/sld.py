...
def build_sld(graph: dict[str, Any], design: dict[str, Any],
    ...
    s.text(30, tb_y + 36, 8.5, f"Generated by GridPilot engineering engine · graph {graph.get('version', '')}")
    s.text(30, tb_y + 50, 8.5, f"Rev A · {date.today().strftime('%m/%d/%Y')} · NOT FOR CONSTRUCTION — PE review required")
    ...
    s.text(CX + 10, (gt_top + gt_bot) / 2, 8.5,
