...
def epc_text(design: dict[str, Any], pf: dict[str, Any], intake: dict[str, Any],
    ...
    lines = [
        ...
        f"{net_mw:g} MW at POI — generated by GridPilot engineering engine",
        ...
        "comments",
        f"Impedances from the GridPilot project graph (equipment library + design engine)",
...
def raw_text(design: dict[str, Any], pf: dict[str, Any], intake: dict[str, Any],
    ...
    L = [
        ...
        f"{intake.get('project_name')} — generated by GridPilot engineering engine",
...
def dyd_text(design: dict[str, Any], intake: dict[str, Any],
    ...
    lines = [
        ...
        f"generated by GridPilot engineering engine",
